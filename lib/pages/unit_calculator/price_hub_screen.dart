...
class PriceHubScreen extends StatefulWidget {
  final MeshItem meshItem;

  const PriceHubScreen({super.key, required this.meshItem});

  @override
  State<PriceHubScreen> createState() => _PriceHubScreenState();
}

class _PriceHubScreenState extends State<PriceHubScreen> {
  @override
  Widget build(BuildContext context) {
    final globalView = Provider.of<GlobalViewProvider>(context);
    return Consumer<PriceHubProvider>(
