...
class CapsuleStaggeredTriangularHoleWpoli extends StatefulWidget {
  final MeshItem item;

  const CapsuleStaggeredTriangularHoleWpoli({super.key, required this.item});

  @override
  State<CapsuleStaggeredTriangularHoleWpoli> createState() => _CapsuleStaggeredTriangularHoleWpoliState();
}

class _CapsuleStaggeredTriangularHoleWpoliState extends State<CapsuleStaggeredTriangularHoleWpoli> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<CapsuleStaggeredTriangularHoleWpoliProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<CapsuleStaggeredTriangularHoleWpoliProvider>(
