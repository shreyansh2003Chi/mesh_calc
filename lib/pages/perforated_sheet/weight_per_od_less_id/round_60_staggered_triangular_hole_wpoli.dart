...
class Round60StaggeredTriangularHoleWpoli extends StatefulWidget {
  final MeshItem item;

  const Round60StaggeredTriangularHoleWpoli({super.key, required this.item});

  @override
  State<Round60StaggeredTriangularHoleWpoli> createState() => _Round60StaggeredTriangularHoleWpoliState();
}

class _Round60StaggeredTriangularHoleWpoliState extends State<Round60StaggeredTriangularHoleWpoli> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<Round60StaggeredTriangularHoleWpoliProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<Round60StaggeredTriangularHoleWpoliProvider>(
