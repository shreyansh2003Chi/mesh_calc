...
class SquareCenterToCenterHoleWpoli extends StatefulWidget {
  final MeshItem item;

  const SquareCenterToCenterHoleWpoli({super.key, required this.item});

  @override
  State<SquareCenterToCenterHoleWpoli> createState() => _SquareCenterToCenterHoleWpoliState();
}

class _SquareCenterToCenterHoleWpoliState extends State<SquareCenterToCenterHoleWpoli> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<SquareCenterToCenterHoleWpoliProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<SquareCenterToCenterHoleWpoliProvider>(
