...
class RectangularStaggeredTriangularHoleWpoli extends StatefulWidget {
  final MeshItem item;

  const RectangularStaggeredTriangularHoleWpoli({super.key, required this.item});

  @override
  State<RectangularStaggeredTriangularHoleWpoli> createState() => _RectangularStaggeredTriangularHoleWpoliState();
}

class _RectangularStaggeredTriangularHoleWpoliState extends State<RectangularStaggeredTriangularHoleWpoli> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<RectangularStaggeredTriangularHoleWpoliProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<RectangularStaggeredTriangularHoleWpoliProvider>(
