...
class Round45StaggeredTriangularHoleWpoli extends StatefulWidget {
  final MeshItem item;

  const Round45StaggeredTriangularHoleWpoli({super.key, required this.item});

  @override
  State<Round45StaggeredTriangularHoleWpoli> createState() => _Round45StaggeredTriangularHoleWpoliState();
}

class _Round45StaggeredTriangularHoleWpoliState extends State<Round45StaggeredTriangularHoleWpoli> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<Round45StaggeredTriangularHoleWpoliProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<Round45StaggeredTriangularHoleWpoliProvider>(
