...
class SquareStaggeredTriangularHoleWpoli extends StatefulWidget {
  final MeshItem item;

  const SquareStaggeredTriangularHoleWpoli({super.key, required this.item});

  @override
  State<SquareStaggeredTriangularHoleWpoli> createState() => _SquareStaggeredTriangularHoleWpoliState();
}

class _SquareStaggeredTriangularHoleWpoliState extends State<SquareStaggeredTriangularHoleWpoli> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<SquareStaggeredTriangularHoleWpoliProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<SquareStaggeredTriangularHoleWpoliProvider>(
