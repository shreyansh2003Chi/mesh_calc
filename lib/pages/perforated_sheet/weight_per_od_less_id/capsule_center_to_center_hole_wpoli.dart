...
class CapsuleCenterToCenterHoleWpoli extends StatefulWidget {
  final MeshItem item;

  const CapsuleCenterToCenterHoleWpoli({super.key, required this.item});

  @override
  State<CapsuleCenterToCenterHoleWpoli> createState() => _CapsuleCenterToCenterHoleWpoliState();
}

class _CapsuleCenterToCenterHoleWpoliState extends State<CapsuleCenterToCenterHoleWpoli> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<CapsuleCenterToCenterHoleWpoliProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<CapsuleCenterToCenterHoleWpoliProvider>(
