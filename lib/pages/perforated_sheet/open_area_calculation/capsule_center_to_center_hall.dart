...
class CapsuleCenterToCenterHall extends StatefulWidget {
  final MeshItem item;

  const CapsuleCenterToCenterHall({super.key, required this.item});

  @override
  State<CapsuleCenterToCenterHall> createState() => _CapsuleCenterToCenterHallState();
}
