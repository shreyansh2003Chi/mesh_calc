...
class RectangularCenterToCenterHole extends StatefulWidget {
  final MeshItem item;

  const RectangularCenterToCenterHole({super.key, required this.item});

  @override
  State<RectangularCenterToCenterHole> createState() => _RectangularCenterToCenterHoleState();
}

class _RectangularCenterToCenterHoleState extends State<RectangularCenterToCenterHole> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<RectangularCenterToCenterHoleProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<RectangularCenterToCenterHoleProvider>(
          builder: (context, p, child) {
            return Column(
              children: [
                Column(
                  children: [
                    Image.asset(AppAssets.rectangularCenterToCenterHole, height: 200, fit: BoxFit.contain),
                    const SizedBox(height: 12),
                    const Text(
                      AppString.rectangularCenterToCenterHole,
