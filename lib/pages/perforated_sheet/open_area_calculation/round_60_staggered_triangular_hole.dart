...
class Round60StaggeredTriangularHole extends StatefulWidget {
  final MeshItem item;

  const Round60StaggeredTriangularHole({super.key, required this.item});

  @override
  State<Round60StaggeredTriangularHole> createState() => _Round60StaggeredTriangularHoleState();
}

class _Round60StaggeredTriangularHoleState extends State<Round60StaggeredTriangularHole> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<Round60StaggeredTriangularHoleProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          AppString.round60StaggeredTriangularHole,
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<Round60StaggeredTriangularHoleProvider>(
          builder: (context, p, child) {
            return Column(
              children: [
                Column(
                  children: [
                    Image.asset(AppAssets.round60StaggeredTriangularHole, height: 200, fit: BoxFit.contain),
