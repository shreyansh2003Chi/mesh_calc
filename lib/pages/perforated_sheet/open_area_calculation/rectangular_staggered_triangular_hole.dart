...
class RectangularStaggeredTriangularHole extends StatefulWidget {
  final MeshItem item;

  const RectangularStaggeredTriangularHole({super.key, required this.item});

  @override
  State<RectangularStaggeredTriangularHole> createState() => _RectangularStaggeredTriangularHoleState();
}

class _RectangularStaggeredTriangularHoleState extends State<RectangularStaggeredTriangularHole> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<RectangularStaggeredTriangularHoleProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          AppString.rectangularStaggeredTriangularHole,
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<RectangularStaggeredTriangularHoleProvider>(
          builder: (context, p, child) {
            return Column(
              children: [
                Column(
                  children: [
                    Image.asset(AppAssets.rectangularStaggeredTriangularHole, height: 200, fit: BoxFit.contain),
