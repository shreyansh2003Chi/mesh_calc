...
class HexagonalStaggeredTriangularHole extends StatefulWidget {
  final MeshItem item;

  const HexagonalStaggeredTriangularHole({super.key, required this.item});

  @override
  State<HexagonalStaggeredTriangularHole> createState() => _HexagonalStaggeredTriangularHoleState();
}

class _HexagonalStaggeredTriangularHoleState extends State<HexagonalStaggeredTriangularHole> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<HexagonalStaggeredTriangularHoleProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<HexagonalStaggeredTriangularHoleProvider>(
          builder: (context, p, child) {
            return Column(
              children: [
                Column(
                  children: [
                    Image.asset(AppAssets.hexagonalStaggeredTriangularHole, height: 200, fit: BoxFit.contain),
                    const SizedBox(height: 12),
                    const Text(
                      AppString.hexagonalStaggeredTriangularHole,
                ...
                Column(
                  children: [
                    ...
                    MeasurementField(
                      ...
                      label: AppString.hexagonalHole,
                      unit: p.hexagonalHoleUnit,
                      onUnitChanged: p.setHexagonalHoleCtrl,
                    ),
