...
class SquareCenterToCenterHole extends StatefulWidget {
  final MeshItem item;

  const SquareCenterToCenterHole({super.key, required this.item});

  @override
  State<SquareCenterToCenterHole> createState() => _SquareCenterToCenterHoleState();
}

class _SquareCenterToCenterHoleState extends State<SquareCenterToCenterHole> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<SquareCenterToCenterHoleProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          AppString.squareCenterToCenterHole,
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<SquareCenterToCenterHoleProvider>(
          builder: (context, p, child) {
            return Column(
              children: [
                Column(
                  children: [
                    Image.asset(AppAssets.squareCenterToCenterHole, height: 200, fit: BoxFit.contain),
