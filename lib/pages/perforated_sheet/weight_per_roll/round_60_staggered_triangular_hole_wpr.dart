...
class Round60StaggeredTriangularHoleWpr extends StatefulWidget {
  final MeshItem item;

  const Round60StaggeredTriangularHoleWpr({super.key, required this.item});

  @override
  State<Round60StaggeredTriangularHoleWpr> createState() => _Round60StaggeredTriangularHoleWprState();
}

class _Round60StaggeredTriangularHoleWprState extends State<Round60StaggeredTriangularHoleWpr> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<Round60StaggeredTriangularHoleWprProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<Round60StaggeredTriangularHoleWprProvider>(
          builder: (context, p, child) {
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Center(
                  child: Image.asset("assets/WPR/round_60_staggered_triangular_hole.jpeg", height: 200, fit: BoxFit.contain),
                ),
