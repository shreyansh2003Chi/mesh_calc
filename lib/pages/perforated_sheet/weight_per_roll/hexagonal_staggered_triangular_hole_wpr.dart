...
class HexagonalStaggeredTriangularHoleWpr extends StatefulWidget {
  final MeshItem item;

  const HexagonalStaggeredTriangularHoleWpr({super.key, required this.item});

  @override
  State<HexagonalStaggeredTriangularHoleWpr> createState() => _HexagonalStaggeredTriangularHoleWprState();
}

class _HexagonalStaggeredTriangularHoleWprState extends State<HexagonalStaggeredTriangularHoleWpr> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<HexagonalStaggeredTriangularHoleWprProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<HexagonalStaggeredTriangularHoleWprProvider>(
          builder: (context, p, child) {
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Center(
                  child: Image.asset("assets/WPR/hexagonal_staggered_triangular_hole.jpeg", height: 200, fit: BoxFit.contain),
                ),
