...
class CapsuleStaggeredTriangularHoleWpr extends StatefulWidget {
  final MeshItem item;

  const CapsuleStaggeredTriangularHoleWpr({super.key, required this.item});

  @override
  State<CapsuleStaggeredTriangularHoleWpr> createState() => _CapsuleStaggeredTriangularHoleWprState();
}

class _CapsuleStaggeredTriangularHoleWprState extends State<CapsuleStaggeredTriangularHoleWpr> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<CapsuleStaggeredTriangularHoleWprProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<CapsuleStaggeredTriangularHoleWprProvider>(
          builder: (context, p, child) {
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Center(
                  child: Image.asset("assets/WPR/capsule_staggered_triangular_hole.jpeg", height: 200, fit: BoxFit.contain),
                ),
