...
class SquareCenterToCenterHoleWpr extends StatefulWidget {
  final MeshItem item;

  const SquareCenterToCenterHoleWpr({super.key, required this.item});

  @override
  State<SquareCenterToCenterHoleWpr> createState() => _SquareCenterToCenterHoleWprState();
}

class _SquareCenterToCenterHoleWprState extends State<SquareCenterToCenterHoleWpr> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<SquareCenterToCenterHoleWprProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<SquareCenterToCenterHoleWprProvider>(
          builder: (context, p, child) {
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Center(
                  child: Image.asset("assets/WPR/square_cenetr_to_center_hole.jpeg", height: 200, fit: BoxFit.contain),
                ),
