...
class SquareStaggeredTriangularHoleWpr extends StatefulWidget {
  final MeshItem item;

  const SquareStaggeredTriangularHoleWpr({super.key, required this.item});

  @override
  State<SquareStaggeredTriangularHoleWpr> createState() => _SquareStaggeredTriangularHoleWprState();
}

class _SquareStaggeredTriangularHoleWprState extends State<SquareStaggeredTriangularHoleWpr> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<SquareStaggeredTriangularHoleWprProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<SquareStaggeredTriangularHoleWprProvider>(
          builder: (context, p, child) {
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Center(
                  child: Image.asset("assets/WPR/square_staggered_triangular_hole.jpeg", height: 200, fit: BoxFit.contain),
                ),
