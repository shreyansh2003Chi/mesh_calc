...
class CapsuleCenterToCenterHoleWpr extends StatefulWidget {
  final MeshItem item;

  const CapsuleCenterToCenterHoleWpr({super.key, required this.item});

  @override
  State<CapsuleCenterToCenterHoleWpr> createState() => _CapsuleCenterToCenterHoleWprState();
}

class _CapsuleCenterToCenterHoleWprState extends State<CapsuleCenterToCenterHoleWpr> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<CapsuleCenterToCenterHoleWprProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<CapsuleCenterToCenterHoleWprProvider>(
          builder: (context, p, child) {
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Center(
                  child: Image.asset("assets/WPR/capsule_center_to_center_hole.jpeg", height: 200, fit: BoxFit.contain),
                ),
