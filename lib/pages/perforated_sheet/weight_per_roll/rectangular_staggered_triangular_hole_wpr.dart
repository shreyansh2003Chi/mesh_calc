...
class RectangularStaggeredTriangularHoleWpr extends StatefulWidget {
  final MeshItem item;

  const RectangularStaggeredTriangularHoleWpr({super.key, required this.item});

  @override
  State<RectangularStaggeredTriangularHoleWpr> createState() => _RectangularStaggeredTriangularHoleWprState();
}

class _RectangularStaggeredTriangularHoleWprState extends State<RectangularStaggeredTriangularHoleWpr> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<RectangularStaggeredTriangularHoleWprProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<RectangularStaggeredTriangularHoleWprProvider>(
          builder: (context, p, child) {
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Center(
                  child: Image.asset("assets/WPR/rectangular_staggered_triangular_hole.jpeg", height: 200, fit: BoxFit.contain),
                ),
