...
class RectangularCenterToCenterHoleWpr extends StatefulWidget {
  final MeshItem item;

  const RectangularCenterToCenterHoleWpr({super.key, required this.item});

  @override
  State<RectangularCenterToCenterHoleWpr> createState() => _RectangularCenterToCenterHoleWprState();
}

class _RectangularCenterToCenterHoleWprState extends State<RectangularCenterToCenterHoleWpr> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<RectangularCenterToCenterHoleWprProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<RectangularCenterToCenterHoleWprProvider>(
          builder: (context, p, child) {
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Center(
                  child: Image.asset("assets/WPR/rectangular_center_to_center_hole.jpeg", height: 200, fit: BoxFit.contain),
                ),
