...
class Round60StaggeredTriangularHoleWpo extends StatefulWidget {
  final MeshItem item;

  const Round60StaggeredTriangularHoleWpo({super.key, required this.item});

  @override
  State<Round60StaggeredTriangularHoleWpo> createState() => _Round60StaggeredTriangularHoleWpoState();
}

class _Round60StaggeredTriangularHoleWpoState extends State<Round60StaggeredTriangularHoleWpo> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<Round60StaggeredTriangularHoleWpoProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<Round60StaggeredTriangularHoleWpoProvider>(
