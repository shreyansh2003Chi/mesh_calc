...
class SquareStaggeredTriangularHoleWpo extends StatefulWidget {
  final MeshItem item;

  const SquareStaggeredTriangularHoleWpo({super.key, required this.item});

  @override
  State<SquareStaggeredTriangularHoleWpo> createState() => _SquareStaggeredTriangularHoleWpoState();
}

class _SquareStaggeredTriangularHoleWpoState extends State<SquareStaggeredTriangularHoleWpo> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<SquareStaggeredTriangularHoleWpoProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<SquareStaggeredTriangularHoleWpoProvider>(
