...
class SquareCenterToCenterHoleWpo extends StatefulWidget {
  final MeshItem item;

  const SquareCenterToCenterHoleWpo({super.key, required this.item});

  @override
  State<SquareCenterToCenterHoleWpo> createState() => _SquareCenterToCenterHoleWpoState();
}

class _SquareCenterToCenterHoleWpoState extends State<SquareCenterToCenterHoleWpo> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<SquareCenterToCenterHoleWpoProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<SquareCenterToCenterHoleWpoProvider>(
