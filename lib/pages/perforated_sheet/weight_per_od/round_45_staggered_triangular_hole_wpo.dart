...
class Round45StaggeredTriangularHoleWpo extends StatefulWidget {
  final MeshItem item;

  const Round45StaggeredTriangularHoleWpo({super.key, required this.item});

  @override
  State<Round45StaggeredTriangularHoleWpo> createState() => _Round45StaggeredTriangularHoleWpoState();
}

class _Round45StaggeredTriangularHoleWpoState extends State<Round45StaggeredTriangularHoleWpo> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<Round45StaggeredTriangularHoleWpoProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<Round45StaggeredTriangularHoleWpoProvider>(
