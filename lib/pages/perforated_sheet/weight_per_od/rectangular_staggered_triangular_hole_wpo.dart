...
class RectangularStaggeredTriangularHoleWpo extends StatefulWidget {
  final MeshItem item;

  const RectangularStaggeredTriangularHoleWpo({super.key, required this.item});

  @override
  State<RectangularStaggeredTriangularHoleWpo> createState() => _RectangularStaggeredTriangularHoleWpoState();
}

class _RectangularStaggeredTriangularHoleWpoState extends State<RectangularStaggeredTriangularHoleWpo> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<RectangularStaggeredTriangularHoleWpoProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<RectangularStaggeredTriangularHoleWpoProvider>(
