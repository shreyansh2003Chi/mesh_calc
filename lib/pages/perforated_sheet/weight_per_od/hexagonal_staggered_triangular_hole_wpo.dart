...
class HexagonalStaggeredTriangularHoleWpo extends StatefulWidget {
  final MeshItem item;

  const HexagonalStaggeredTriangularHoleWpo({super.key, required this.item});

  @override
  State<HexagonalStaggeredTriangularHoleWpo> createState() => _HexagonalStaggeredTriangularHoleWpoState();
}

class _HexagonalStaggeredTriangularHoleWpoState extends State<HexagonalStaggeredTriangularHoleWpo> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<HexagonalStaggeredTriangularHoleWpoProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<HexagonalStaggeredTriangularHoleWpoProvider>(
