...
class WeightPerRoll extends StatefulWidget {
  ...
  const WeightPerRoll({super.key, required this.item});
          ...
          builder: (context, p, child) {
            return Column(
              children: [
                Column(
                  children: [
                    Image.asset(AppAssets.weightPerRoll2, height: 200, fit: BoxFit.contain),
                    const SizedBox(height: 12),
                    const Text(
                      AppString.weightPerRoll,
