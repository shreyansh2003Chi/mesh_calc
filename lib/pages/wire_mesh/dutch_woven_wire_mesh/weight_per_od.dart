...
class WeightPerOd extends StatefulWidget {
  ...
  const WeightPerOd({super.key, required this.item});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<WeightPerOdProvider>(
          builder: (context, p, child) {
            return Column(
              children: [
                Column(
                  children: [
                    Image.asset(AppAssets.weightPerOd2, height: 200, fit: BoxFit.contain),
