...
class SquareWireMesh extends StatefulWidget {
  final MeshItem item;

  const SquareWireMesh({super.key, required this.item});

  @override
  State<SquareWireMesh> createState() => _SquareWireMeshState();
}

class _SquareWireMeshState extends State<SquareWireMesh> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<SquareWireMeshProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<SquareWireMeshProvider>(
