...
class MeshCalculation extends StatefulWidget {
  final MeshItem item;

  const MeshCalculation({super.key, required this.item});

  @override
  State<MeshCalculation> createState() => _MeshCalculationState();
}

class _MeshCalculationState extends State<MeshCalculation> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<MeshCalculationProvider>(context, listen: false).clearControllers();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<MeshCalculationProvider>(
