...
class MeshOpeningPitchCalculationsWw extends StatefulWidget {
  const MeshOpeningPitchCalculationsWw({super.key});

  @override
  State<MeshOpeningPitchCalculationsWw> createState() => _MeshOpeningPitchCalculationsWwState();
}

class _MeshOpeningPitchCalculationsWwState extends State<MeshOpeningPitchCalculationsWw> {
  @override
  Widget build(BuildContext context) {
    final globalView = Provider.of<GlobalViewProvider>(context);
    return Consumer<MeshOpeningPitchCalculationsWwProvider>(
