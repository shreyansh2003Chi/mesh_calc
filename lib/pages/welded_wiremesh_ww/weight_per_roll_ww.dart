...
class WeightPerRollWw extends StatefulWidget {
  final MeshItem meshItem;

  const WeightPerRollWw({super.key, required this.meshItem});

  @override
  State<WeightPerRollWw> createState() => _WeightPerRollWwState();
}

class _WeightPerRollWwState extends State<WeightPerRollWw> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<WeightPerRollWwProvider>(context, listen: false).clearController();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<WeightPerRollWwProvider>(
