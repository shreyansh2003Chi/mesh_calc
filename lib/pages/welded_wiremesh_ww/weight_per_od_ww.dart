...
class WeightPerOdWw extends StatefulWidget {
  final MeshItem meshItem;

  const WeightPerOdWw({super.key, required this.meshItem});

  @override
  State<WeightPerOdWw> createState() => _WeightPerOdWwState();
}

class _WeightPerOdWwState extends State<WeightPerOdWw> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<WeightPerOdWwProvider>(context, listen: false).clearController();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<WeightPerOdWwProvider>(
