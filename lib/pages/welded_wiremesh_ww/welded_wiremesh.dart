...
class WeldedWiremesh extends StatefulWidget {
  const WeldedWiremesh({super.key});

  @override
  State<WeldedWiremesh> createState() => _WeldedWiremeshState();
}

class _WeldedWiremeshState extends State<WeldedWiremesh> {
  @override
  Widget build(BuildContext context) {
    final globalView = Provider.of<GlobalViewProvider>(context);
    return Consumer<WeldedWiremeshProvider>(
