...
class OctagonalWireScreen extends StatefulWidget {
  final MeshItem meshItem;

  const OctagonalWireScreen({super.key, required this.meshItem});

  @override
  State<OctagonalWireScreen> createState() => _OctagonalWireScreenState();
}

class _OctagonalWireScreenState extends State<OctagonalWireScreen> {
  @override
  void initState() {
    Provider.of<OctagonalWireProvider>(context, listen: false).clearController();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<OctagonalWireProvider>(
