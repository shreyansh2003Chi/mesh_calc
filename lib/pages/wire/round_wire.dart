...
class RoundWireScreen extends StatefulWidget {
  final MeshItem meshItem;

  const RoundWireScreen({super.key, required this.meshItem});

  @override
  State<RoundWireScreen> createState() => _RoundWireScreenState();
}

class _RoundWireScreenState extends State<RoundWireScreen> {
  @override
  void initState() {
    Provider.of<RoundWireProvider>(context, listen: false).clearController();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<RoundWireProvider>(
