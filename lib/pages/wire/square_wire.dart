...
class SquareWireScreen extends StatefulWidget {
  final MeshItem meshItem;

  const SquareWireScreen({super.key, required this.meshItem});

  @override
  State<SquareWireScreen> createState() => _SquareWireScreenState();
}

class _SquareWireScreenState extends State<SquareWireScreen> {
  @override
  void initState() {
    Provider.of<SquareWireProvider>(context, listen: false).clearController();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<SquareWireProvider>(
