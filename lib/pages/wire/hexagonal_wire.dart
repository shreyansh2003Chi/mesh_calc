...
class HexagonalWireScreen extends StatefulWidget {
  final MeshItem meshItem;

  const HexagonalWireScreen({super.key, required this.meshItem});

  @override
  State<HexagonalWireScreen> createState() => _HexagonalWireScreenState();
}

class _HexagonalWireScreenState extends State<HexagonalWireScreen> {
  @override
  void initState() {
    Provider.of<HexagonalWireProvider>(context, listen: false).clearController();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<HexagonalWireProvider>(
          builder: (context, p, child) {
            return Column(
              children: [
                ...
                MeasurementField(controller: p.thicknessCtrl, label: AppString.wireThicknessWt, unit: p.thicknessUnit, onUnitChanged: p.setThicknessUnit),
