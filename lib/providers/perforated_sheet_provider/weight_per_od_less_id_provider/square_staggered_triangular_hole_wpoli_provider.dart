...
class SquareStaggeredTriangularHoleWpoliProvider with ChangeNotifier {
  ...
  void setSquareHoleUnit(MeasureUnit u) { squareHoleUnit = u; notifyListeners(); }
