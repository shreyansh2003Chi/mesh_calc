...
class HexagonalStaggeredTriangularHoleWpoProvider with ChangeNotifier {
  ...
  void setHexagonalHoleUnit(MeasureUnit u) {
    hexagonalHoleUnit = u;
    notifyListeners();
  }
  ...
  void setPerforationDiameterUnit(MeasureUnit u) {
    perforationDiameterUnit = u;
    notifyListeners();
  }
  ...
  Future<void> calculate() async {
    ...
    double h = _toMm(hexagonalHole, hexagonalHoleUnit);
